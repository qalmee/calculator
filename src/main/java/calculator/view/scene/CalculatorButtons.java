...
public enum CalculatorButtons {
    ...
    BUTTON_DIGIT0(4, 3,
            new Button(getProperty("calculator_scene.button0")), CalculatorMode.BASIC),
    BUTTON_DIGIT1(3, 2,
            new Button(getProperty("calculator_scene.button1")), CalculatorMode.BASIC),
    BUTTON_DIGIT2(3, 3,
            new Button(getProperty("calculator_scene.button2")), CalculatorMode.BASIC),
    BUTTON_DIGIT3(3, 4,
            new Button(getProperty("calculator_scene.button3")), CalculatorMode.BASIC),
    BUTTON_DIGIT4(2, 2,
            new Button(getProperty("calculator_scene.button4")), CalculatorMode.BASIC),
    BUTTON_DIGIT5(2, 3,
            new Button(getProperty("calculator_scene.button5")), CalculatorMode.BASIC),
    BUTTON_DIGIT6(2, 4,
            new Button(getProperty("calculator_scene.button6")), CalculatorMode.BASIC),
    BUTTON_DIGIT7(1, 2,
            new Button(getProperty("calculator_scene.button7")), CalculatorMode.BASIC),
    BUTTON_DIGIT8(1, 3,
            new Button(getProperty("calculator_scene.button8")), CalculatorMode.BASIC),
    BUTTON_DIGIT9(1, 4,
            new Button(getProperty("calculator_scene.button9")), CalculatorMode.BASIC),

    BUTTON_CLEAR_ENTRY(0, 2,
            new Button(getProperty("calculator_scene.button_clear_entry")), CalculatorMode.BASIC),
    BUTTON_GLOBAL_CLEAR(0, 3,
            new Button(getProperty("calculator_scene.button_global_clear")), CalculatorMode.BASIC),
    BUTTON_BACKSPACE(0, 4,
            new Button(getProperty("calculator_scene.button_backspace")), CalculatorMode.BASIC),

    BUTTON_DIVIDE(0, 5,
            new Button(getProperty("calculator_scene.button_divide")), CalculatorMode.BASIC),
    BUTTON_MULTIPLY(1, 5,
            new Button(getProperty("calculator_scene.button_multiply")), CalculatorMode.BASIC),
    BUTTON_MINUS(2, 5,
            new Button(getProperty("calculator_scene.button_minus")), CalculatorMode.BASIC),
    BUTTON_PLUS(3, 5,
            new Button(getProperty("calculator_scene.button_plus")), CalculatorMode.BASIC),

    BUTTON_SQUARE(3, 1,
            new Button(getProperty("calculator_scene.button_square")), CalculatorMode.BASIC),
    BUTTON_REVERSE(4, 1,
            new Button(getProperty("calculator_scene.button_reverse")), CalculatorMode.BASIC),

    BUTTON_DOT(4, 4,
            new Button(getProperty("calculator_scene.button_dot")), CalculatorMode.BASIC),
    BUTTON_ENTER(4, 5,
            new Button(getProperty("calculator_scene.button_enter")), CalculatorMode.BASIC),
    BUTTON_PLUS_MINUS(4, 2,
            new Button(getProperty("calculator_scene.button_plus_minus")), CalculatorMode.BASIC),

    BUTTON_MEMORY_CLEAR(1, 0,
            new Button(getProperty("calculator_scene.button_memory_clear")), CalculatorMode.BASIC),
    BUTTON_MEMORY_SAVE(2, 0,
            new Button(getProperty("calculator_scene.button_memory_save")), CalculatorMode.BASIC),
    BUTTON_MEMORY_COPY(3, 0,
            new Button(getProperty("calculator_scene.button_memory_copy")), CalculatorMode.BASIC),
    BUTTON_MEMORY_ADD(4, 0,
            new Button(getProperty("calculator_scene.button_memory_add")), CalculatorMode.BASIC),
